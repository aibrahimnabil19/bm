export const navItems = [
  ...
  { href: '/admin/bank', label: 'Banque', iconClass: 'fa-solid fa-bank' },
  { href: '/admin/expenses', label: 'Depense', iconClass: 'fa-solid fa-money-bill' },
  { href: '/admin/management', label: 'Gerence', iconClass: 'fa-solid fa-users' },
  { href: '/admin/stats', label: 'Statistique', iconClass: 'fa-solid fa-chart-bar' },
];